...
<head>
  ...
  <title>Netplayz • Portfolio</title>
...
<body class="bg-slate-50 text-slate-900">
  ...
  <header class="max-w-5xl mx-auto p-6 flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-extrabold">Netplayz</h1>
      <p class="text-sm text-slate-600">Developer • Designer • CISO-ish (Baysn)</p>
    </div>
  ...
  <main class="max-w-5xl mx-auto p-6">
    ...
    <section class="bg-white rounded-2xl p-8 shadow-sm mb-8">
      <div class="md:flex md:items-center md:justify-between">
        <div>
          <h2 class="text-4xl font-extrabold mb-2">Hi — I’m Netplayz.</h2>
          <p class="text-lg text-slate-700 mb-4">
            I build playful-yet-practical web tools, Linux builds, and automation that saves time. I love clean
            design, oddly-specific engineering challenges, and building free community tools.
          </p>
          <div class="flex gap-3">
            <a href="#projects" class="inline-block px-4 py-2 rounded-lg bg-slate-900 text-white font-medium">
              View projects
            </a>
            <a href="#contact" class="inline-block px-4 py-2 rounded-lg border border-slate-200">
              Get in touch
            </a>
          </div>
        </div>
        ...
        <div class="mt-6 md:mt-0 flex items-center justify-center">
          <div class="w-40 h-40 bg-gradient-to-tr from-slate-800 to-slate-600 rounded-full shadow-lg flex items-center justify-center text-white text-sm font-bold">
            NetByte
          </div>
        </div>
      </div>
    ...
    <!-- Skills -->
    <section id="skills" class="mb-8 bg-white p-6 rounded-xl shadow-sm">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-3 rounded-lg shadow-sm">
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm font-medium">Linux</span><span class="text-xs text-slate-500">90%</span>
          </div>
          <div class="w-full h-2 bg-slate-100 rounded-full overflow-hidden"><div class="h-full bg-slate-800" style="width:90%"></div></div>
        </div>
      </div>
